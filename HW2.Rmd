...
profs |>
  ggplot() +
  geom_histogram(aes(x = eval), binwidth = 0.1, fill = "#009fe9", color = "black") +
  labs(
...
profs |>
  ggplot() + 
  geom_boxplot(aes(x = eval, y = as.factor(native), fill = as.factor(native))) + 
  labs(
...
profs |>
  ggplot() +
  geom_histogram(aes(x = eval), fill = "#009fe9", color = "black", binwidth = 0.1) + 
  facet_wrap(~gender, ) +
  labs(
...
profs |>
  ggplot() +
  geom_point(aes(x = eval, y = beauty), color = "#009fe9") +
  labs(
...
bikeshare_hourly |>
  ggplot() +
  geom_line(aes(x = hr, y = avg_totals), color = "#009fe9", linewidth = 1) + 
  labs(
...
bikeshare_wday |>
  ggplot() + 
  geom_line(aes(x = hr, y = avg_totals), color = "#009fe9", linewidth = 1) +
  facet_wrap(~workingday, labeller = as_labeller(c("Yes" = "Working Day", "No" = "Non-working Day"))) +
  labs(
...
unique_songs |>
  ggplot() +
  geom_line(aes(x = year, y = unique_songs), color = "#009fe9", size = 1) + 
  labs(
...
ten_week_hits |>
  ggplot() +
  geom_col(aes(x = performer, y = ten_week_hits), fill = "#009fe9") + 
  coord_flip() +
  labs(
